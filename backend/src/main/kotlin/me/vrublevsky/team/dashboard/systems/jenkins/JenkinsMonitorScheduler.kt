...
import me.vrublevsky.team.dashboard.configuration.SlackJenkinsMonitor
...
class JenkinsMonitorScheduler(
    ...
    fun updateJenkinsData() {
        dashboardConfiguration.slack.jenkinsMonitor.forEach { jenkinsMonitor ->
            performCheck(jenkinsMonitor)
        }
    }

    private fun performCheck(jenkinsMonitor: SlackJenkinsMonitor) {
